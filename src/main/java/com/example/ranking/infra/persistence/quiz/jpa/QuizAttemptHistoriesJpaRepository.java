...
public interface QuizAttemptHistoriesJpaRepository extends JpaRepository<QuizAttemptHistoriesEntity, Long> {
    ...
    @Query("select qah from QuizAttemptHistoriesEntity qah " +
            ...
            "and qah.user = :user")
    List<QuizAttemptHistoriesEntity> findQuizAttemptHistoriesEntitiesByQuestionStatusAndUser(@Param("questionStatus") QuestionStatus questionStatus, @Param("user") UsersEntity usersEntity);
